...
export function WeatherSearch() {
    ...
    function onInputValueChange(inputValue: string, event: ComboboxRoot.ChangeEventDetails) {
    ...
    >
        <ComboboxInput
            className="w-full border-0 border-b-2 rounded-b-none has-[[data-slot=input-group-control]:focus-visible]:ring-0 has-[[data-slot=input-group-control]:focus-visible]:border-ring"
            showTrigger={false}
